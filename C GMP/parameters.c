...
PTEsolution n7ex1, n7ex2, n7ex3, n7ex4, n7ex5, n7ex6, n7ex7, n7ex8, n7ex9, n7ex10;	//examples with degree n=7
PTEsolution n8ex1;								//example with degree n=8

//set all parameters accordingly to the chosen example PTE solution
void setParameters (PTEsolution *PTE, unsigned short *degree, unsigned short *numberRoots, short **roots, short **polyA, short **polyB, mpz_t *C) {
...
//define available examples
	...
	static short roots76[14] = {0, 6, 66, 108, 114, 180, 234, 300, 336, 408, 420, 474, 486, 504};
	n7ex6.roots = roots76;
...
//set parameters to the ones of the chosen example	
	...
	*polyB = PTE->polyB;
	//*C = PTE->C;
	unsigned int i;
	mpz_set_ui(*C, (unsigned int) (*polyB)[0]);
	for (i = 1; i < PTE->degree; i++) {
		mpz_mul_ui(*C, *C, (unsigned int) (*polyB)[i]);
	}
	/*disabled for gmp version:
